            ...
            children: <Widget>[
              Align(
                ...
                child: RichText(
                  text: TextSpan(
                    children: [
                      WidgetSpan(
                        child: Icon(Icons.circle, size: 16, color: Color(overdueColour),),
                      ),
                      TextSpan(
                        text: "Overdue",
                        style: TextStyle(color: Color(overdueColour), fontSize: 14, fontWeight: FontWeight.bold),
                      ),
                    ],
                  ),
                ),
              ...
              Padding(
                ...
                child: RichText(
                  text: TextSpan(
                    children: [
                      WidgetSpan(
                        child: Icon(Icons.calendar_today_outlined, size: 20, color: Color(0xffE28F22),),
                      ),
                      TextSpan(
                        text: " ${DateFormat(' dd-MM-yyyy').format(customReminder.reminderDateTime)}",
              ...
              Padding(
                ...
                child: RichText(
                  text: TextSpan(
                    children: [
                      WidgetSpan(
                        child: Icon(Icons.alarm, size: 20, color: Color(0xffE28F22),),
                      ),
                      TextSpan(
                        text: "  ${DateFormat('HH:mm').format(customReminder.reminderDateTime)}",
                        style: TextStyle(color: Colors.black, fontSize: 16),
                      ),
                    ],
                  ),
              ...
              Row(
                ...
                children: [
                  ...
                  IconButton(
                    icon: Icon(Icons.delete, color: Color(0xff235790),),
                      onPressed: () {
                        showDialog(
                          context: context,
                          builder: (BuildContext context) {
                            return new AlertDialog(
                              ...
                              actions: <Widget>[
                                new TextButton(
                                    child: new Text('Cancel', style: TextStyle(color: Color(0xff235790)),),
                                    onPressed: () => Navigator.of(context).pop()
                                ),
                                new TextButton(
                                    child: new Text('Delete', style: TextStyle(color: Color(0xff235790)),),
                                    onPressed: () {
